...
namespace TinTrinhLibrary
{
    public class WebClient
    {
        ...
        public String Get(string url, string referer, string returnCookie)
        {
            ...
            webRequest.UserAgent = " Mozilla/5.0 (Windows NT 10.0; WOW64; rv:51.0) Gecko/20100101 Firefox/51.0";
            webRequest.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
            webRequest.Headers[HttpRequestHeader.AcceptLanguage] = "vi,en-US;q=0.7,en;q=0.3";
